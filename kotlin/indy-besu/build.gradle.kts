    ...
    builds {
        ...
        jvm {
            ...
            if (rustTarget == RustPosixTarget.MinGWX64) {
                variants {
                    dynamicLibraries.set(listOf("indy_besu_vdr_uniffi.dll"))
                }
            }
        }
    }
...
publishing {
    ...
    publications.withType<MavenPublication> {
        ...
        pom {
            name.set("Indy Besu VDR Uniffi Kotlin")
            description.set("Kotlin MPP wrapper around aries indy-besu vdr uniffi")
